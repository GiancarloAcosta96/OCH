...
class crudNotadecargo
{
    ...
    public function agregarNCmovil($datos)
    {
        ...
        $sqlLLAMADA = "INSERT INTO nc_movil (id_usuario, id_supervisor,fecha_ingreso, ruc,razon_social,q_lineas,cargo_fijo,modalidad,tipo,
        contacto,telefono1,telefono2,estado,validacion,zonal,comentario_ejecutivo,oportunidad,nodo)
                                    values ('$datos[0]',
                                            '$datos[1]',
                                            '$hoy',
                                            '$datos[5]',
    ...
    public function obtenCargoMovil($idcargo)
    {
        ...
        $sql = "SELECT nc.q_lineas,nc.modalidad,nc.cargo_fijo,nc.ruc,
                ...
                t.nombre,usu.personal,nc.comentario_ejecutivo,nc.estado
                    from nc_movil as nc inner join usuario as usu on nc.id_usuario=usu.id_usuario
                    left join tienda as t on t.id_tienda=nc.zonal
                    where id_cargo ='$idcargo' ";
    ...
    public function agregarncmBack($datos)
    {
        ...
        $sqlnotadecargo = "UPDATE nc_movil SET estado='$datos[2]',fecha_actualizacion='$datos[6]' , 
            comentario_back='$datos[5]' , id_cartera='$datos[3]'
            , zonal_telefonica='$datos[4]', id_back='$datos[0]',oportunidad='$datos[7]',nodo='$datos[8]'
    ...
    public function obtenDatosEjecutivo($dat)
    {
        ...
        $sql = " SELECT id_cartera,nombre,propietario,estado,DNI FROM cartera WHERE  id_tienda='$dat' and estado=1 ";
