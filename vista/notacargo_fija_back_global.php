...
<![endif]-->
  ...
  <body class="skin-blue">
                  ...
                  <form id="frmNCFB" method="post">
                    <div class="row">
                      ...
                      <div class="col-xs-4">
                        ...
                        <input type="text" class="form-control input-sm" id="nccontrata" name="nccontrata">
                    ...
                    <div id="nuevocliente" style="display:show">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="date" class="form-control input-sm" id="ncfechaliq" name="ncfechaliq">
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-4">
                          ...
                          <input type="text" class="form-control input-sm" id="ncnunasignado" name="ncnunasignado">

                        </div>

                        <div class="col-xs-4">
                          <label>Caso SF</label>
                          <input type="text" class="form-control input-sm" id="nccasosf" name="nccasosf">
                    ...
                    <div id="comun" style="display:show">
                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          ...
                          <div class="form-group">
                            <textarea class="form-control" rows="10" id="nccomentarioback" name="nccomentarioback"></textarea>
                          </div>
                        </div>
                      </div>
    ...
    <script type="text/javascript" src="js/notacargo_fija_back_global.js"></script>
