                                ...
                                <div class="modal-body">
                                    <form id="frmNCM" method="post">
                                        ...
                                        <div id="titular" style="display:show">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <input type="text" disabled="" class="form-control input-sm" id="fechaTickets" name="fechaTickets" required>
                                        ...
                                        <div id="comun" style="display:show">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <label>Número de problema</label>
