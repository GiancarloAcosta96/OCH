                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <select name="ncperiodo" class="form-control" id='ncperiodo'>
                                    ...
                                    <option value="TODOMES" selected>TODO</option>
                                </select>
                            </div>
                                    ...
                                    <form id="frmNCF" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <input type="number" class="form-control input-sm" id="ncqlineas" name="ncqlineas" disabled="" value='1' required>
                                ...
                                <div class="modal-body">
                                    <form id="frmNCFS" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <label>Q lineas</label>
                                                <input type="number" class="form-control input-sm" id="ncqlineass" name="ncqlineass" disabled="">
