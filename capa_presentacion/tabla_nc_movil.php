...
ORDER BY ncf.fecha_ingreso DESC";
  ...
  ncf.cargo_fijo, ncf.estado,ncf.validacion
 from nc_movil as ncf 
where month(ncf.fecha_actualizacion)='$periodo' and year(ncf.fecha_actualizacion)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado='$estado'
ORDER BY ncf.fecha_ingreso DESC";
    } else {
...
from nc_movil as ncf 
where  year(ncf.fecha_ingreso)<='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado in ('INGRESADO','PROCESANDO','PENDIENTE','DELIVERY','BOLSA','SALIDAANTICIPADA')
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_movil as ncf 
where month(ncf.fecha_actualizacion)='$periodo' and year(ncf.fecha_actualizacion)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado='ACTIVADO'
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_movil as ncf 
where month(ncf.fecha_ingreso)='$periodo' and year(ncf.fecha_ingreso)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado='CAIDA'
